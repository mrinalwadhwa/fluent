...
- [inject-side-effects-for-testability](inject-side-effects-for-testability.md) — Side-effect functions must be injected via &dyn Fn parameters so tests can capture and assert
