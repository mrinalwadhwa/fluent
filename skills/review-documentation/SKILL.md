...
description: >
  ...
  Produces a verdict and findings artifact. Uses the write-documentation
  skill as its quality reference.
---
...
- **Findings, not rewrites.** Report what's wrong and where. The author
  determines the fix.
- **Use write-documentation as the reference.** The write-documentation
  skill defines what good documentation looks like. Check against it.
