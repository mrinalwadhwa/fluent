...
paths such as `../work-<work-item-id>-<attempt-id>`. Cleanup, dashboard,
and merge follow-up work should treat `.factory/work/` as durable state
and managed sibling worktrees as transient execution roots.
