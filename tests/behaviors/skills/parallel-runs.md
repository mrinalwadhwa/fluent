# Scenario: Make the factory work better for multiple runs

## Opening statement
I want the factory to handle multiple runs at the same time better.

## Hidden context
- This is deliberately vague — the user hasn't fully thought it through
- The real trigger: they had two runs going and factory status was confusing — hard to tell which was which
...
- The real ask might shrink to just "improve factory status display for multiple runs" once probed
...
- Did it read the factory status code?
